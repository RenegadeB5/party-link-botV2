...
module.exports = class PingCommand extends Command { 
	...
	async run(msg,user) {
		...
		msg.member.addRole(banrole).then(message.mentions.members.first().send('You have been banned from accessing member-links! The only way the punishment will be lifted is if you sincerely apologize to a staff member.'));
	}
}
exports.help = {
	name: "linkban"
